...
#define TM_PANTHER_WARNING   (TM_PANTHER_BASE + 2)
#define TM_PANTHER_FINISH    (TM_PANTHER_BASE + 3)
#define TM_PANTHER_FILENAME  (TM_PANTHER_BASE + 4)
#define TM_PANTHER_BOOTSTEP  (TM_PANTHER_BASE + 5)
